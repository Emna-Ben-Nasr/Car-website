{{-- <div>
    <h1>home page </h1>
    {{-- <h1>My name is {{ $name }} and surname is {{ $surname }} </h1> --}}

{{-- </div> --}}
{{-- --}}
{{-- <h2>year : {{ $year }}</h2>
<div @style(['color:green', 'background-color:red' => $name === 'emna'])>
    my name is emna
</div>
@includeIf ('shared file.button', ['color' => 'red', 'text' => 'submit']) --}}
{{-- @php
    $cars = ['polo', 'handai', 'isuzi'];
@endphp

@each('Contact.car.view', $cars, 'car', 'view.empty')

@include('challenge.alert', ['color' => 'red', 'message' => 'hello  '])
@include('challenge.alert', ['color' => 'green', 'message' => 'hello there ']) --}}

{{-- @extends('layouts.app',["cssclass"=>"none"])
